    ...
    listCards.forEach((value, key)=>{
        ...
        if(value != null){
            ...
            newDiv.innerHTML = `
                ...
                <div>
                    <button class="btn-cantidad" onclick="changeQuantity(${key}, ${value.quantity - 1})">-</button>
...
checkoutBtn.addEventListener('click', () => {
  ...
  // Mostrar la alerta con el mensaje y el código del pedido
  Swal.fire({
    title: '¡Tu pedido ha sido realizado con éxito!',
    text: `Código del pedido: ${code}`,
    icon: 'success',
